...
<template lang="">
    <aside class="w-[290px] flex-shrink-0 bg-white border-r border-gray-200 flex flex-col justify-between p-5 lg:block hidden h-screen">
      ...
      <div class="bg-gray-50 rounded-2xl p-5 space-y-4 fixed bottom-0 w-[260px]">
